...
class Films(Base):
    ...
    producers = Column(String(250), nullable=False)
    opening_crawl = Column(String(250), nullable=False)
    related_charcters = Column(String(250), nullable=False)
    related_starships = Column(String(250), nullable=False)
    related_species = Column(String(250), nullable=False)
    related_planets = Column(String(250), nullable=False)
    related_vehicles  = Column(String(250), nullable=False)
...
class Species(Base):
    ...
    avg_lifespan = Column(String(250), nullable=False)
    avg_height = Column(String(250), nullable=False)
    hair_color = Column(String(250), nullable=False)
    skin_color = Column(String(250), nullable=False)
